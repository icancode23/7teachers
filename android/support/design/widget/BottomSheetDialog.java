...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    class C02662 extends AccessibilityDelegateCompat {
        C02662() {
        }
    ...
    class C02673 extends BottomSheetCallback {
        C02673() {
        }
    ...
    public BottomSheetDialog(@NonNull Context context, @StyleRes int theme) {
        ...
        this.mBottomSheetCallback = new C02673();
    ...
    private View wrapInBottomSheet(int layoutResId, View view, LayoutParams params) {
        ...
        coordinator.findViewById(C0010R.id.touch_outside).setOnClickListener(new C00181());
        ViewCompat.setAccessibilityDelegate(bottomSheet, new C02662());
        return coordinator;
    }
