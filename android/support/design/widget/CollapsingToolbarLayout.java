...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    class C02691 implements OnApplyWindowInsetsListener {
        C02691() {
        }
    ...
    class C02702 implements AnimatorUpdateListener {
        C02702() {
        }
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mCollapsingTextHelper.setCollapsedTextAppearance(C0170R.style.TextAppearance_AppCompat_Widget_ActionBar_Title);
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C02691());
    }
    ...
    private void animateScrim(int targetAlpha) {
        ...
        if (this.mScrimAnimator == null) {
            ...
            this.mScrimAnimator.addUpdateListener(new C02702());
