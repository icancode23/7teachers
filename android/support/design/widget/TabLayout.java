...
public class TabLayout extends HorizontalScrollView {
    ...
    class C02791 implements AnimatorUpdateListener {
        C02791() {
        }
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = context.obtainStyledAttributes(this.mTabTextAppearance, C0170R.styleable.TextAppearance);
        try {
            this.mTabTextSize = (float) ta.getDimensionPixelSize(C0170R.styleable.TextAppearance_android_textSize, 0);
            this.mTabTextColors = ta.getColorStateList(C0170R.styleable.TextAppearance_android_textColor);
        ...
        if (newPosition != -1) {
            ...
            if (startScrollX != targetScrollX) {
                if (this.mScrollAnimator == null) {
                    ...
                    this.mScrollAnimator.addUpdateListener(new C02791());
                }
