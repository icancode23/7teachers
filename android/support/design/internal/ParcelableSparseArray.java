...
public class ParcelableSparseArray extends SparseArray<Parcelable> implements Parcelable {
    public static final Creator<ParcelableSparseArray> CREATOR = ParcelableCompat.newCreator(new C02531());

    static class C02531 implements ParcelableCompatCreatorCallbacks<ParcelableSparseArray> {
        C02531() {
        }
