...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C01091();
    ...
    static class C01091 implements Creator<PlaybackStateCompat> {
        C01091() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C01101();
        ...
        static class C01101 implements Creator<CustomAction> {
            C01101() {
            }
