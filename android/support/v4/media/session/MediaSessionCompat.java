...
public class MediaSessionCompat {
    ...
    public static final class QueueItem implements Parcelable {
        public static final Creator<QueueItem> CREATOR = new C01051();
        public static final int UNKNOWN_ID = -1;
        private final MediaDescriptionCompat mDescription;
        private final long mId;
        private Object mItem;

        static class C01051 implements Creator<QueueItem> {
            C01051() {
            }
    ...
    static final class ResultReceiverWrapper implements Parcelable {
        public static final Creator<ResultReceiverWrapper> CREATOR = new C01061();
        private ResultReceiver mResultReceiver;

        static class C01061 implements Creator<ResultReceiverWrapper> {
            C01061() {
            }
    ...
    public static final class Token implements Parcelable {
        public static final Creator<Token> CREATOR = new C01071();
        private final Object mInner;

        static class C01071 implements Creator<Token> {
            C01071() {
            }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        final String mTag;
        private final Token mToken;
        private android.support.v4.media.VolumeProviderCompat.Callback mVolumeCallback = new C03031();
        ...
        class C03031 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C03031() {
            }
        ...
        class C03712 implements Callback {
            C03712() {
            }
