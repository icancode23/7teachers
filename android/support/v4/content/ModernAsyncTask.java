...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C00681();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C02932();
    ...
    class C02932 extends WorkerRunnable<Params, Result> {
        C02932() {
        }
