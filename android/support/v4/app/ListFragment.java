...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C00662();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C00651();
    ...
    class C00662 implements OnItemClickListener {
        C00662() {
        }
