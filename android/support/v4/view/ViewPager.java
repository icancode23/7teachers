...
public class ViewPager extends ViewGroup {
    ...
    class C03144 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C03151());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        static class C03151 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C03151() {
            }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C03144());
    }
