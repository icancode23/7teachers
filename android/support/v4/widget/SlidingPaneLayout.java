...
public class SlidingPaneLayout extends ViewGroup {
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C03251());
        boolean isOpen;

        static class C03251 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C03251() {
            }
