...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new C01531();
    ...
    private final Runnable mSetIdleRunnable = new C01542();
    private int mTouchSlop;
    private int mTrackingEdges;
    private VelocityTracker mVelocityTracker;

    static class C01531 implements Interpolator {
        C01531() {
        }
