...
public abstract class ForwardingListener implements OnTouchListener {
    ...
    class C01941 implements OnAttachStateChangeListener {
        C01941() {
        }
    ...
    private void addDetachListenerApi12(View src) {
        src.addOnAttachStateChangeListener(new C01941());
    }

    private void addDetachListenerBase(View src) {
        src.getViewTreeObserver().addOnGlobalLayoutListener(new C01952());
    }
