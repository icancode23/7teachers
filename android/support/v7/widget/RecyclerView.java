...
import android.support.v7.recyclerview.C0171R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    static final Interpolator sQuinticInterpolator = new C02033();
    ...
    static class C02033 implements Interpolator {
        C02033() {
        }
    ...
    public static abstract class LayoutManager {
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0171R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0171R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0171R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0171R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0171R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    class C03484 implements ProcessCallback {
        C03484() {
        }
    ...
    class C03495 implements Callback {
        C03495() {
        }
    ...
    class C03506 implements Callback {
        C03506() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C03511());
        Parcelable mLayoutState;

        static class C03511 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C03511() {
            }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C02011();
        ...
        this.mItemAnimatorRunner = new C02022();
        this.mViewInfoProcessCallback = new C03484();
        if (attrs != null) {
        ...
        if (attrs != null) {
            a = context.obtainStyledAttributes(attrs, C0171R.styleable.RecyclerView, defStyle, 0);
            String layoutManagerName = a.getString(C0171R.styleable.RecyclerView_layoutManager);
            if (a.getInt(C0171R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C03495());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C03506());
    }
