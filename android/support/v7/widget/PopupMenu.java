...
public class PopupMenu {
    ...
    class C02002 implements android.widget.PopupWindow.OnDismissListener {
        C02002() {
        }
    ...
    class C03461 implements Callback {
        C03461() {
        }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity) {
        this(context, anchor, gravity, C0170R.attr.popupMenuStyle, 0);
    }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes) {
        ...
        this.mMenu.setCallback(new C03461());
        ...
        this.mPopup.setOnDismissListener(new C02002());
    }
