...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0170R.attr.actionBarSize, 16842841};
    ...
    class C03781 extends ViewPropertyAnimatorListenerAdapter {
        C03781() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C03781();
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0170R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0170R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0170R.id.action_bar));
        }
    }
