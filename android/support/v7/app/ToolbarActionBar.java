...
class ToolbarActionBar extends ActionBar {
    ...
    private final OnMenuItemClickListener mMenuClicker = new C03312();
    private final Runnable mMenuInvalidator = new C01691();
    ...
    class C03312 implements OnMenuItemClickListener {
        C03312() {
        }
...
*/
    ...
    private void ensureListMenuPresenter(Menu menu) {
        if (this.mListMenuPresenter == null && (menu instanceof MenuBuilder)) {
            ...
            this.mListMenuPresenter = new ListMenuPresenter(context2, C0170R.layout.abc_list_menu_item_layout);
