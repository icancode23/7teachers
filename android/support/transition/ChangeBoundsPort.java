...
class ChangeBoundsPort extends TransitionPort {
    ...
    class C00343 extends AnimatorListenerAdapter {
        C00343() {
        }
    ...
    class C03661 extends TransitionListenerAdapter {
    ...
    class C03672 extends TransitionListenerAdapter {
        boolean mCanceled = false;
            ...
            if (numChanges > 0) {
                ...
                if (this.mResizeClip) {
                    ...
                    if (view.getParent() instanceof ViewGroup) {
                        ...
                        addListener(new C03672());
                    }
                    anim.addListener(new C00343());
                    return anim;
                }
                pvh = new PropertyValuesHolder[numChanges];
                if (startLeft != endLeft) {
