...
public class bregact extends AppCompatActivity {
    Button bpass;
    EditText ettest;
    ...
    public class serverConnect extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            bregact.this.mProgressBar.setVisibility(4);
            bregact.this.tvloading.setText("");
            if (this.id == 0) {
                new Builder(bregact.this).setMessage((CharSequence) "WRONG USERNAME/PASSWORD").setNegativeButton((CharSequence) "Retry", null).create().show();
            } else {
                new Builder(bregact.this).setMessage((CharSequence) "Email CHANGED").setNegativeButton((CharSequence) "OK", null).create().show();
            }
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView((int) C0231R.layout.activity_bregact);
        ...
        this.bpass.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                bregact.this.mProgressBar.setVisibility(0);
                bregact.this.tvloading.setText("Loading");
